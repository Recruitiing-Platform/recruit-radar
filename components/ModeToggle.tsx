...
export function ModeToggle() {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="z-[300] mt-2 border-0 shadow-[2px_2px_8px_0px_rgba(194,193,193,0.59)] dark:shadow-[2px_2px_4px_2px_rgba(198,198,198,0.07)] dark:bg-[#000]">
