    ...
    <div className='p-4 md:px-10 lg:px-20 3xl:px-56 md:py-10 lg:py-20 flex flex-col md:flex-row items-center justify-between gap-5'>
      {/* Image */}
        ...
        <div className='hidden lg:flex flex-col'>
          {/* topic and arrows */}
          <div>
            <h1 className='font-recSemiBold text-headerThree w-2/3 pb-4 pt-1 3xl:text-headerTwo'>What Our Users Say About <span className='text-recPrimary'>RecruitRadar</span></h1>
          </div>
          <CarouselPlugin />
        </div>
