...
const HireComponent = (props: Props) => {
  return (
    <div className="sm:hidden md:block md:pr-12 md:pl-3 lg:pl-32 lg:pr-44 xl:px-10 pb-40">
      <div className='relative h-[450px]'>
        ...
        <div className='absolute top-[30%] lg:top-[40%] left-[22%] h-80 xl:h-64 w-[480px] xl:w-[700px] bg-recPrimary/25 rounded-full blur-effect'></div>
        <div className='absolute top-[30%] lg:top-[40%] right-[20%] lg:left-[25%] md:w-1/2 lg:w-[60%] xl:w-1/2 text-center'>
            ...
            <p className='text-headerSix font-recRegular leading-8 md:pb-7 lg:pb-11'>Along with conventional advertising & below the line activities & organiztions have come to realize that they need to invest</p>
