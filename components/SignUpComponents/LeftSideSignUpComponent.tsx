...
const LeftSideSignUpComponent = () => {
  ...
  return (
    <div className="hidden md:flex w-[50%] flex-col items-center dark:bg-[#000611] bg-recLightGrey text-recSecondary relative">
      ...
      <RightSideTextComponent fromColor='#150096' toColor='#9F0BA2' className='relative w-[70%] h-1/2 sm:hidden md:flex items-center dark:hidden justify-center' />
      <RightSideTextComponent fromColor='#150096' toColor='#9F0BA2' className='relative w-[70%] h-1/2 sm:hidden md:dark:flex items-center hidden justify-center' />
