// components/MainEducationComponent.tsx
...
const MainEducationComponent: React.FC<Props> = (props: Props) => {
      ...
      <form className="bg-white rounded shadow-md">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-2/3">
            <div className="mb-4">
              <label className="block text-recBody mb-2"><strong>School Name</strong></label>
              <input
                type="text"
  ...
  <div className="relative">
    ...
    >
      ...
      <option value="fct">Federal Capital Territory, Nigeria</option>
    </select>
