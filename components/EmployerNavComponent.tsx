      ...
      >
        ...
        <div className="flex gap-6 items-center">
          <Link href="/signup" className="hidden lg:block">
            <span className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-[#FF595A] text-recPrimary bg-background h-10 w-40 hover:font-recBold transition duration-200">
              Try for Free
            </span>
          </Link>
          <ModeToggle />
